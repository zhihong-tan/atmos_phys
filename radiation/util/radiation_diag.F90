...
!  </DESCRIPTION>
!  <TEMPLATE>
!   call radiation_diag_driver (is, ie, js, je, Rad_diag)
!  </TEMPLATE>
!  <IN NAME="is, ie, js, je" TYPE="integer">
!   starting/ending subdomain i,j indices of data in 
!                   the physics_window being integrated
!  </IN>
!  <IN NAME="Rad_diag" TYPE="radiation_diag_type">
!   radiation_diag_type variable containing diagnostic
!   longwave and shortwave output used by the radiation diagnostics
!   module
!  </IN>
! </SUBROUTINE>
!
...
!  </DESCRIPTION>
!  <TEMPLATE>
!   call radiag (is, ie, js, je, jrow, Rad_diag)
!  </TEMPLATE>
!  <IN NAME="is, ie, js, je" TYPE="integer">
!   starting/ending subdomain i,j indices of data in 
!                   the physics_window being integrated
...
!  <IN NAME="Rad_diag" TYPE="radiation_diag_type">
!   radiation_diag_type variable containing diagnostic
!   longwave and shortwave output used by the radiation
!   diagnostics module
!  </IN>
! </SUBROUTINE>
!
