...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 public cloud_tau_driver,diag_cloud_rad_init
...
real, intent(in), dimension(:,:,:) ::  &
     &           cldamt,delp_true,tempcld,pfull,phalf
...
!  Assuming that coszen is being passed in as an argument                                                        
real,    intent(in), dimension (:,:)  ::  coszen, psfc

!  real, intent (in)  :: taucrit
...
real, dimension(size(tau,1),size(tau,2),size(tau,3)) :: delp
...
real,     intent (out),dimension(:,:,:,:)   :: tau,w0,gg
...
!---------------------------------------------------------------------
      ...
      if ( get_my_pe() == 0 ) write (unit, nml=diag_cloud_rad_nml)
      call close_file (unit)
