...
!--------------------------------------------------------------------
      ...
      loss(:,1) = ((rxt(:,47) +rxt(:,48))* y(:,3) + rxt(:,4))* y(:,4)
      prod(:,1) = 0.
      loss(:,2) = (rxt(:,64)* y(:,3) +rxt(:,63)* y(:,17) +rxt(:,193)* y(:,72)) &
                 * y(:,12)
      prod(:,2) = 0.
      loss(:,3) = ((rxt(:,72) +rxt(:,73))* y(:,17))* y(:,16)
      prod(:,3) = 0.
      loss(:,4) = (rxt(:,100)* y(:,17))* y(:,29)
      prod(:,4) = 0.
      loss(:,5) = (rxt(:,146)* y(:,17))* y(:,42)
      prod(:,5) = 0.
      loss(:,6) = (rxt(:,74)* y(:,3) +rxt(:,83)* y(:,17))* y(:,61)
      prod(:,6) =.050*rxt(:,64)*y(:,12)*y(:,3)
      loss(:,7) = (rxt(:,46)* y(:,3) + (rxt(:,56) +rxt(:,219))* y(:,11) +rxt(:,220) &
                 * y(:,71) +rxt(:,225)* y(:,78) + rxt(:,14))* y(:,84)
...
!--------------------------------------------------------------------
         ...
         loss(67) = (rxt(43)* y(2) +rxt(50)* y(6) +rxt(52)* y(7) +rxt(77)* y(17) &
                  +rxt(78)* y(18) +rxt(85)* y(20) +rxt(99)* y(21) +rxt(110)* y(30) &
                  +rxt(119)* y(34) +rxt(121)* y(35) +rxt(138)* y(41) +rxt(163)* y(57) &
                  +rxt(188)* y(72) +rxt(202)* y(79) +rxt(186)* y(83) + rxt(2) &
                  + rxt(3))* y(1)
         prod(67) = (.100*rxt(99)*y(21) +.200*rxt(119)*y(34) +.200*rxt(121)*y(35)) &
                 *y(1) + (.300*rxt(94)*y(25) +.300*rxt(131)*y(38))*y(18) +rxt(42)*y(2)
         loss(15) = ((rxt(47) +rxt(48))* y(4) +rxt(64)* y(12) +rxt(74)* y(61) +rxt(46) &
                 * y(84) + rxt(44) + rxt(45))* y(3)
         prod(15) =rxt(2)*y(1)
         loss(68) = (rxt(43)* y(1) +rxt(215)* y(6) +rxt(51)* y(7) +rxt(75)* y(17) &
                  +rxt(76)* y(18) +rxt(192)* y(71) +rxt(189)* y(73) +rxt(207)* y(76) &
                  + rxt(42))* y(2)
         prod(68) = (rxt(144) +rxt(145)*y(6) +rxt(216)*y(7))*y(5) + (rxt(3) + &
                 .765*rxt(138)*y(41))*y(1) + (rxt(44) +rxt(45))*y(3) +rxt(5)*y(6) &
                  +rxt(6)*y(7) +.890*rxt(9)*y(8) +rxt(82)*y(17)*y(17) +rxt(40)*y(80)
         loss(14) = (rxt(145)* y(6) +rxt(216)* y(7) + rxt(144))* y(5)
         prod(14) =rxt(5)*y(6)
         loss(70) = (rxt(50)* y(1) +rxt(215)* y(2) +rxt(145)* y(5) +rxt(59)* y(8) &
                  +rxt(65)* y(13) +rxt(49)* y(18) +rxt(87)* y(22) +rxt(92)* y(25) &
                  +rxt(113)* y(33) + (rxt(122) +rxt(123))* y(36) +rxt(129)* y(38) &
                  +rxt(101)* y(39) +rxt(147)* y(43) +rxt(107)* y(51) +rxt(152)* y(54) &
                  +rxt(157)* y(56) +rxt(166)* y(58) +rxt(190)* y(73) +rxt(206)* y(80) &
                  + rxt(5))* y(6)
         prod(70) = (rxt(6) +.500*rxt(143) +rxt(51)*y(2) +rxt(213)*y(8))*y(7) &
                  +2.000*rxt(47)*y(4)*y(3) +rxt(144)*y(5) +.110*rxt(9)*y(8)
         loss(76) = (rxt(52)* y(1) +rxt(51)* y(2) +rxt(216)* y(5) +rxt(54)* y(8) &
                  +rxt(57)* y(17) +rxt(60)* y(18) +rxt(93)* y(25) +rxt(135)* y(38) &
                  +rxt(191)* y(73) +rxt(203)* y(80) + rxt(6) + rxt(143))* y(7)
         prod(76) = (rxt(49)*y(18) +rxt(50)*y(1) +2.000*rxt(59)*y(8) +rxt(65)*y(13) + &
                 rxt(87)*y(22) +rxt(92)*y(25) +rxt(101)*y(39) +rxt(107)*y(51) + &
                 .920*rxt(113)*y(33) +rxt(122)*y(36) +rxt(129)*y(38) +rxt(147)*y(43) + &
                 rxt(152)*y(54) +1.206*rxt(157)*y(56) +rxt(166)*y(58) + &
                 rxt(190)*y(73) +rxt(206)*y(80) +rxt(215)*y(2))*y(6) + (.890*rxt(9) + &
                 rxt(53)*y(18) +rxt(114)*y(33) +rxt(124)*y(36) +rxt(130)*y(38) + &
                 rxt(139)*y(41) +1.206*rxt(158)*y(56) +rxt(164)*y(57) + &
                 rxt(167)*y(58) +rxt(183)*y(65) +2.000*rxt(214)*y(8))*y(8) &
                  + (rxt(10) +rxt(62) +rxt(61)*y(17))*y(10) + (rxt(7) +rxt(55) + &
                 rxt(218)*y(69))*y(11) + (rxt(30) +.400*rxt(162)*y(17) + &
                 .400*rxt(163)*y(1))*y(57) + (.600*rxt(19) +rxt(97))*y(27) &
                  + (rxt(20) +rxt(136))*y(32) +rxt(8)*y(9) +rxt(155)*y(28)*y(17) &
                  +.206*rxt(159)*y(56)*y(18)
         loss(65) = (rxt(59)* y(6) + (rxt(54) +rxt(213))* y(7) + 2.*rxt(214)* y(8) &
                  +rxt(70)* y(15) +rxt(53)* y(18) +rxt(86)* y(20) +rxt(156)* y(21) &
                  +rxt(91)* y(23) +rxt(114)* y(33) +rxt(124)* y(36) +rxt(130)* y(38) &
                  +rxt(139)* y(41) +rxt(161)* y(55) +rxt(158)* y(56) +rxt(164)* y(57) &
                  +rxt(167)* y(58) +rxt(183)* y(65) + rxt(9) + rxt(141))* y(8)
         prod(65) = (rxt(58)*y(9) +.500*rxt(176)*y(32) +rxt(177)*y(27))*y(17) &
                  + (rxt(7) +rxt(55))*y(11) + (rxt(34) +rxt(192)*y(2))*y(71) &
                  +rxt(52)*y(7)*y(1) +.400*rxt(19)*y(27) +rxt(37)*y(78)
         loss(39) = (rxt(58)* y(17) + rxt(8))* y(9)
         prod(39) = (rxt(141) +rxt(70)*y(15) +rxt(91)*y(23) +rxt(161)*y(55))*y(8) &
                  + (2.000*rxt(140) +2.000*rxt(56)*y(84) +2.000*rxt(219)*y(84) + &
                 rxt(218)*y(69))*y(11) + (.500*rxt(143) +rxt(57)*y(17))*y(7) &
                  + (rxt(220)*y(84) +rxt(221)*y(69))*y(71) +rxt(225)*y(84)*y(78)
         loss(19) = (rxt(61)* y(17) + rxt(10) + rxt(62))* y(10)
         prod(19) =rxt(60)*y(18)*y(7)
         loss(29) = (rxt(218)* y(69) + (rxt(56) +rxt(219))* y(84) + rxt(7) + rxt(55) &
                  + rxt(140))* y(11)
         prod(29) =rxt(54)*y(8)*y(7)
         loss(64) = (rxt(65)* y(6) + 2.*(rxt(66) +rxt(67))* y(13) +rxt(68)* y(18) &
                  +rxt(95)* y(25) +rxt(116)* y(33) +rxt(126)* y(36) +rxt(132)* y(38) &
                  +rxt(103)* y(39) +rxt(149)* y(43) +rxt(169)* y(58))* y(13)
         prod(64) = (rxt(92)*y(6) +.900*rxt(95)*y(13) +2.000*rxt(98)*y(25) + &
                 rxt(117)*y(33) +rxt(127)*y(36) +rxt(133)*y(38) +rxt(170)*y(58))*y(25) &
                  + (rxt(63)*y(17) +.750*rxt(64)*y(3) +rxt(193)*y(72))*y(12) &
                  +.310*rxt(85)*y(20)*y(1) +.700*rxt(69)*y(17)*y(14) +rxt(16)*y(23) &
                  +rxt(18)*y(26) +.400*rxt(19)*y(27) +.300*rxt(23)*y(34) +rxt(27) &
                 *y(45)
         loss(25) = (rxt(69)* y(17) + rxt(11))* y(14)
         prod(25) =rxt(68)*y(18)*y(13)
         loss(74) = (rxt(70)* y(8) +rxt(71)* y(17) +rxt(198)* y(72) +rxt(209)* y(79) &
                  + rxt(12) + rxt(13))* y(15)
         prod(74) = (rxt(65)*y(6) +2.000*rxt(66)*y(13) +rxt(67)*y(13) +rxt(95)*y(25) + &
                 .700*rxt(103)*y(39) +1.200*rxt(116)*y(33) +.880*rxt(126)*y(36) + &
                 2.000*rxt(132)*y(38) +rxt(149)*y(43) +.700*rxt(169)*y(58))*y(13) &
                  + (.540*rxt(85)*y(20) +.600*rxt(99)*y(21) +rxt(110)*y(30) + &
                 .800*rxt(119)*y(34) +.700*rxt(121)*y(35) +1.326*rxt(138)*y(41))*y(1) &
                  + (rxt(87)*y(22) +.550*rxt(113)*y(33) +.250*rxt(122)*y(36) + &
                 rxt(129)*y(38) +rxt(152)*y(54) +.072*rxt(157)*y(56))*y(6) &
                  + (.300*rxt(69)*y(14) +.500*rxt(96)*y(26) +.500*rxt(106)*y(30) + &
                 rxt(174)*y(47) +.500*rxt(176)*y(32) +rxt(177)*y(27))*y(17) &
                  + (.600*rxt(114)*y(33) +.250*rxt(124)*y(36) +rxt(130)*y(38) + &
                 .072*rxt(158)*y(56))*y(8) + (.600*rxt(117)*y(33) + &
                 .250*rxt(127)*y(36) +rxt(133)*y(38))*y(25) +.250*rxt(64)*y(12)*y(3) &
                  +rxt(11)*y(14) +.008*rxt(159)*y(56)*y(18) +rxt(17)*y(24) &
                  +1.340*rxt(21)*y(35) +2.000*rxt(134)*y(38)*y(38) +rxt(26)*y(46) &
                  +rxt(33)*y(49) +rxt(32)*y(50) +2.000*rxt(109)*y(52) +rxt(30)*y(57) &
                  +.690*rxt(31)*y(60)
         loss(75) = (rxt(77)* y(1) +rxt(75)* y(2) +rxt(57)* y(7) +rxt(58)* y(9) &
                  +rxt(61)* y(10) +rxt(63)* y(12) +rxt(69)* y(14) +rxt(71)* y(15) &
                  + (rxt(72) +rxt(73))* y(16) + 2.*(rxt(82) +rxt(199))* y(17) +rxt(81) &
                 * y(18) +rxt(80)* y(19) +rxt(84)* y(20) +rxt(111)* y(21) +rxt(90) &
                 * y(23) +rxt(89)* y(24) +rxt(96)* y(26) +rxt(177)* y(27) +rxt(155) &
                 * y(28) +rxt(100)* y(29) +rxt(106)* y(30) +rxt(112)* y(31) +rxt(176) &
                 * y(32) +rxt(118)* y(34) +rxt(120)* y(35) +rxt(128)* y(37) +rxt(105) &
                 * y(40) +rxt(137)* y(41) +rxt(146)* y(42) +rxt(150)* y(44) +rxt(151) &
                 * y(45) +rxt(154)* y(46) +rxt(174)* y(47) +rxt(175)* y(48) +rxt(179) &
                 * y(49) +rxt(178)* y(50) +rxt(165)* y(53) +rxt(160)* y(55) +rxt(162) &
                 * y(57) +rxt(171)* y(59) +rxt(173)* y(60) +rxt(83)* y(61) +rxt(180) &
                 * y(63) + (rxt(181) +rxt(182))* y(65) +rxt(185)* y(66) +rxt(194) &
                 * y(69) + (rxt(197) +rxt(212))* y(73) +rxt(210)* y(77))* y(17)
         prod(75) = (rxt(78)*y(18) +.330*rxt(85)*y(20) +.270*rxt(99)*y(21) + &
                 .120*rxt(110)*y(30) +.080*rxt(119)*y(34) +.215*rxt(121)*y(35) + &
                 1.156*rxt(138)*y(41) +rxt(186)*y(83))*y(1) + (.300*rxt(69)*y(14) + &
                 .500*rxt(89)*y(24) +.500*rxt(105)*y(40) +.100*rxt(128)*y(37))*y(17) &
                  + (2.000*rxt(46)*y(84) +.750*rxt(64)*y(12) +rxt(74)*y(61))*y(3) &
                  + (rxt(49)*y(6) +rxt(53)*y(8) +rxt(76)*y(2))*y(18) + (rxt(38) + &
                 rxt(207)*y(2))*y(76) +.500*rxt(143)*y(7) +rxt(8)*y(9) +rxt(11)*y(14) &
                  +2.000*rxt(15)*y(19) +rxt(17)*y(24) +rxt(18)*y(26) +.660*rxt(22) &
                 *y(35) +rxt(24)*y(40) +rxt(25)*y(44) +rxt(26)*y(46) +rxt(29)*y(59) &
                  +rxt(35)*y(70)
         loss(71) = (rxt(78)* y(1) +rxt(76)* y(2) +rxt(49)* y(6) +rxt(60)* y(7) &
                  +rxt(53)* y(8) +rxt(68)* y(13) +rxt(81)* y(17) + 2.*rxt(79)* y(18) &
                  +rxt(88)* y(22) +rxt(94)* y(25) +rxt(115)* y(33) +rxt(125)* y(36) &
                  +rxt(131)* y(38) +rxt(102)* y(39) +rxt(148)* y(43) +rxt(153)* y(54) &
                  +rxt(159)* y(56) +rxt(168)* y(58) +rxt(195)* y(72) +rxt(196)* y(73) &
                  +rxt(208)* y(79) +rxt(205)* y(80) + rxt(142))* y(18)
         prod(71) = (rxt(72)*y(16) +rxt(83)*y(61) +rxt(71)*y(15) +rxt(77)*y(1) + &
                 rxt(80)*y(19) +.250*rxt(106)*y(30) +.200*rxt(128)*y(37) + &
                 rxt(162)*y(57) +rxt(174)*y(47) +rxt(175)*y(48) +.500*rxt(176)*y(32) + &
                 rxt(178)*y(50) +.600*rxt(179)*y(49) +rxt(197)*y(73))*y(17) &
                  + (rxt(65)*y(6) +2.000*rxt(66)*y(13) +.900*rxt(95)*y(25) + &
                 rxt(103)*y(39) +rxt(116)*y(33) +.730*rxt(126)*y(36) +rxt(132)*y(38) + &
                 rxt(149)*y(43) +rxt(169)*y(58))*y(13) + (.190*rxt(85)*y(20) + &
                 .060*rxt(99)*y(21) +.120*rxt(110)*y(30) +.060*rxt(119)*y(34) + &
                 .275*rxt(121)*y(35) +.102*rxt(138)*y(41) +rxt(163)*y(57))*y(1) &
                  + (rxt(87)*y(22) +rxt(101)*y(39) +rxt(113)*y(33) + &
                 .470*rxt(122)*y(36) +rxt(147)*y(43) +.794*rxt(157)*y(56) + &
                 1.500*rxt(166)*y(58))*y(6) + (rxt(70)*y(15) +rxt(114)*y(33) + &
                 .470*rxt(124)*y(36) +.794*rxt(158)*y(56) +rxt(164)*y(57) + &
                 1.500*rxt(167)*y(58))*y(8) + (rxt(12) +rxt(198)*y(72) + &
                 rxt(209)*y(79))*y(15) + (rxt(117)*y(33) +.470*rxt(127)*y(36) + &
                 1.500*rxt(170)*y(58))*y(25) + (.200*rxt(64)*y(12) +rxt(74)*y(61)) &
                 *y(3) + (rxt(10) +rxt(62))*y(10) + (rxt(108) +rxt(109))*y(52) &
                  +rxt(11)*y(14) +.794*rxt(159)*y(56)*y(18) +rxt(16)*y(23) +rxt(17) &
                 *y(24) +1.340*rxt(21)*y(35) +1.200*rxt(104)*y(39)*y(39) +rxt(24) &
                 *y(40) +rxt(25)*y(44) +2.000*rxt(33)*y(49) +rxt(32)*y(50) +rxt(28) &
                 *y(55) +rxt(30)*y(57) +rxt(31)*y(60) +rxt(187)*y(83)
         loss(10) = (rxt(80)* y(17) + rxt(15))* y(19)
         prod(10) =rxt(199)*y(17)*y(17) +rxt(79)*y(18)*y(18)
         loss(50) = (rxt(85)* y(1) +rxt(86)* y(8) +rxt(84)* y(17))* y(20)
         prod(50) = (.070*rxt(99)*y(21) +.119*rxt(138)*y(41))*y(1) +.700*rxt(23)*y(34)
         loss(47) = (rxt(99)* y(1) +rxt(156)* y(8) +rxt(111)* y(17))* y(21)
         prod(47) = 0.
         loss(41) = (rxt(87)* y(6) +rxt(88)* y(18))* y(22)
         prod(41) = (rxt(84)*y(20) +.500*rxt(89)*y(24))*y(17)
         loss(51) = (rxt(91)* y(8) +rxt(90)* y(17) + rxt(16))* y(23)
         prod(51) = (rxt(87)*y(22) +rxt(101)*y(39) +.270*rxt(147)*y(43))*y(6) &
                  + (.500*rxt(85)*y(20) +.040*rxt(119)*y(34))*y(1) &
                  + (.500*rxt(105)*y(40) +rxt(175)*y(48))*y(17) &
                  + (.800*rxt(103)*y(13) +1.600*rxt(104)*y(39))*y(39) +rxt(17)*y(24) &
                  +rxt(24)*y(40)
         loss(32) = (rxt(89)* y(17) + rxt(17))* y(24)
         prod(32) =rxt(88)*y(22)*y(18)
         loss(62) = (rxt(92)* y(6) +rxt(93)* y(7) +rxt(95)* y(13) +rxt(94)* y(18) &
                  + 2.*rxt(98)* y(25) +rxt(117)* y(33) +rxt(127)* y(36) +rxt(170) &
                 * y(58))* y(25)
         prod(62) = (rxt(91)*y(23) +.530*rxt(124)*y(36) +rxt(130)*y(38) + &
                 rxt(161)*y(55))*y(8) + (.530*rxt(122)*y(36) +rxt(129)*y(38) + &
                 rxt(152)*y(54))*y(6) + (rxt(90)*y(23) +.500*rxt(96)*y(26) + &
                 rxt(160)*y(55))*y(17) + (.260*rxt(126)*y(36) +rxt(132)*y(38))*y(13) &
                  + (.600*rxt(19) +rxt(97))*y(27) +.530*rxt(127)*y(36)*y(25) &
                  +.300*rxt(23)*y(34) +1.340*rxt(21)*y(35) +2.000*rxt(134)*y(38)*y(38) &
                  +rxt(27)*y(45) +rxt(26)*y(46) +rxt(32)*y(50) +rxt(28)*y(55)
         loss(30) = (rxt(96)* y(17) + rxt(18))* y(26)
         prod(30) = (.700*rxt(94)*y(25) +.700*rxt(131)*y(38))*y(18)
         loss(33) = (rxt(177)* y(17) + rxt(19) + rxt(97))* y(27)
         prod(33) =rxt(93)*y(25)*y(7)
         loss(17) = (rxt(155)* y(17))* y(28)
         prod(17) =rxt(86)*y(20)*y(8)
         loss(20) = (rxt(110)* y(1) +rxt(106)* y(17))* y(30)
         prod(20) = 0.
         loss(6) = (rxt(112)* y(17))* y(31)
         prod(6) = 0.
         loss(35) = (rxt(176)* y(17) + rxt(20) + rxt(136))* y(32)
         prod(35) =rxt(135)*y(38)*y(7)
         loss(60) = (rxt(113)* y(6) +rxt(114)* y(8) +rxt(116)* y(13) +rxt(115)* y(18) &
                  +rxt(117)* y(25))* y(33)
         prod(60) = (rxt(111)*y(21) +1.640*rxt(137)*y(41) +.500*rxt(173)*y(60))*y(17) &
                  +1.700*rxt(139)*y(41)*y(8)
         loss(58) = (rxt(119)* y(1) +rxt(118)* y(17) + rxt(23))* y(34)
         prod(58) = (.320*rxt(113)*y(6) +.350*rxt(114)*y(8) +.260*rxt(116)*y(13) + &
                 .350*rxt(117)*y(25))*y(33) + (.039*rxt(157)*y(6) + &
                 .039*rxt(158)*y(8) +.039*rxt(159)*y(18))*y(56) &
                  + (.200*rxt(99)*y(21) +.442*rxt(138)*y(41))*y(1) +.402*rxt(31)*y(60)
         loss(56) = (rxt(121)* y(1) +rxt(120)* y(17) + rxt(21) + rxt(22))* y(35)
         prod(56) = (.230*rxt(113)*y(6) +.250*rxt(114)*y(8) +.190*rxt(116)*y(13) + &
                 .250*rxt(117)*y(25))*y(33) + (.167*rxt(157)*y(6) + &
                 .167*rxt(158)*y(8) +.167*rxt(159)*y(18))*y(56) &
                  + (.400*rxt(99)*y(21) +1.122*rxt(138)*y(41))*y(1) +.288*rxt(31) &
                 *y(60)
         loss(61) = ((rxt(122) +rxt(123))* y(6) +rxt(124)* y(8) +rxt(126)* y(13) &
                  +rxt(125)* y(18) +rxt(127)* y(25))* y(36)
         ...
         loss(63) = (rxt(129)* y(6) +rxt(135)* y(7) +rxt(130)* y(8) +rxt(132)* y(13) &
                  +rxt(131)* y(18) +rxt(133)* y(25) + 2.*rxt(134)* y(38))* y(38)
         prod(63) = (.500*rxt(120)*y(35) +.500*rxt(128)*y(37) +.800*rxt(179)*y(49)) &
                 *y(17) + (rxt(20) +rxt(136))*y(32) +.200*rxt(99)*y(21)*y(1) &
                  +.660*rxt(21)*y(35)
         loss(40) = (rxt(101)* y(6) +rxt(103)* y(13) +rxt(102)* y(18) + 2.*rxt(104) &
                 * y(39))* y(39)
         ...
         loss(48) = (rxt(138)* y(1) +rxt(139)* y(8) +rxt(137)* y(17))* y(41)
         prod(48) = 0.
         loss(45) = (rxt(147)* y(6) +rxt(149)* y(13) +rxt(148)* y(18))* y(43)
         prod(45) = (rxt(146)*y(42) +1.330*rxt(112)*y(31) +rxt(150)*y(44))*y(17)
         loss(23) = (rxt(150)* y(17) + rxt(25))* y(44)
         prod(23) =rxt(148)*y(43)*y(18)
         loss(37) = (rxt(151)* y(17) + rxt(27))* y(45)
         prod(37) = (.820*rxt(147)*y(6) +.820*rxt(149)*y(13))*y(43) &
                  +.100*rxt(137)*y(41)*y(17) +.820*rxt(25)*y(44)
         loss(24) = (rxt(154)* y(17) + rxt(26))* y(46)
         prod(24) =rxt(153)*y(54)*y(18)
         loss(34) = (rxt(174)* y(17))* y(47)
         prod(34) = (rxt(67)*y(13) +.300*rxt(103)*y(39) +.250*rxt(116)*y(33) + &
                 .250*rxt(126)*y(36) +.300*rxt(169)*y(58))*y(13)
         loss(18) = (rxt(175)* y(17))* y(48)
         prod(18) = (.200*rxt(103)*y(13) +.400*rxt(104)*y(39))*y(39)
         loss(42) = (rxt(179)* y(17) + rxt(33))* y(49)
         prod(42) = (.530*rxt(122)*y(6) +.530*rxt(124)*y(8) +.260*rxt(126)*y(13) + &
                 .530*rxt(127)*y(25))*y(36) + (.250*rxt(166)*y(6) + &
                 .250*rxt(167)*y(8) +.100*rxt(169)*y(13) +.250*rxt(170)*y(25))*y(58) &
                  +rxt(108)*y(52)
         loss(55) = (rxt(178)* y(17) + rxt(32))* y(50)
         prod(55) = (.220*rxt(122)*y(6) +.220*rxt(124)*y(8) +.230*rxt(126)*y(13) + &
                 .220*rxt(127)*y(25))*y(36) + (.250*rxt(166)*y(6) + &
                 .250*rxt(167)*y(8) +.100*rxt(169)*y(13) +.250*rxt(170)*y(25))*y(58) &
                  + (.500*rxt(89)*y(24) +.500*rxt(176)*y(32))*y(17)
         loss(28) = (rxt(107)* y(6))* y(51)
         prod(28) =.750*rxt(106)*y(30)*y(17)
         loss(11) = ( + rxt(108) + rxt(109))* y(52)
         prod(11) =rxt(107)*y(51)*y(6)
         loss(31) = (rxt(165)* y(17))* y(53)
         prod(31) = (.370*rxt(113)*y(6) +.400*rxt(114)*y(8) +.300*rxt(116)*y(13) + &
                 .400*rxt(117)*y(25))*y(33) + (.400*rxt(162)*y(17) + &
                 .400*rxt(163)*y(1))*y(57)
         loss(44) = (rxt(152)* y(6) +rxt(153)* y(18))* y(54)
         prod(44) = (rxt(151)*y(45) +rxt(154)*y(46))*y(17)
         loss(54) = (rxt(161)* y(8) +rxt(160)* y(17) + rxt(28))* y(55)
         prod(54) = (.250*rxt(122)*y(6) +.250*rxt(124)*y(8) +.240*rxt(126)*y(13) + &
                 .250*rxt(127)*y(25))*y(36) + (.250*rxt(166)*y(6) + &
                 .250*rxt(167)*y(8) +.100*rxt(169)*y(13) +.250*rxt(170)*y(25))*y(58) &
                  + (.950*rxt(119)*y(34) +.800*rxt(121)*y(35))*y(1) &
                  + (rxt(155)*y(28) +rxt(178)*y(50))*y(17)
         loss(43) = (rxt(157)* y(6) +rxt(158)* y(8) +rxt(159)* y(18))* y(56)
         prod(43) =rxt(156)*y(21)*y(8)
         loss(52) = (rxt(163)* y(1) +rxt(164)* y(8) +rxt(162)* y(17) + rxt(30))* y(57)
         prod(52) = (.080*rxt(113)*y(33) +rxt(123)*y(36) +.794*rxt(157)*y(56))*y(6) &
                  + (.794*rxt(158)*y(8) +.794*rxt(159)*y(18))*y(56)
         loss(59) = (rxt(166)* y(6) +rxt(167)* y(8) +rxt(169)* y(13) +rxt(168)* y(18) &
                  +rxt(170)* y(25))* y(58)
         prod(59) = (rxt(165)*y(53) +rxt(171)*y(59) +.500*rxt(173)*y(60))*y(17)
         loss(12) = ((rxt(171) +rxt(172))* y(17) + rxt(29))* y(59)
         prod(12) =rxt(168)*y(58)*y(18)
         loss(36) = (rxt(173)* y(17) + rxt(31))* y(60)
         prod(36) =rxt(115)*y(33)*y(18)
         loss(8) = (rxt(180)* y(17))* y(63)
         prod(8) = (rxt(181)*y(17) +.750*rxt(182)*y(17) +rxt(183)*y(8))*y(65)
         loss(1) = 0.
         prod(1) =rxt(180)*y(63)*y(17)
         loss(13) = (rxt(183)* y(8) + (rxt(181) +rxt(182))* y(17))* y(65)
         prod(13) = 0.
         loss(5) = (rxt(185)* y(17) + rxt(184))* y(66)
         prod(5) = 0.
         loss(2) = 0.
         prod(2) = 0.
         loss(3) = 0.
         prod(3) =rxt(184)*y(66)
         loss(69) = (rxt(218)* y(11) +rxt(194)* y(17) +rxt(217)* y(70) +rxt(221) &
                 * y(71) +rxt(222)* y(76))* y(69)
         prod(69) = (rxt(193)*y(12) +rxt(195)*y(18) +rxt(198)*y(15))*y(72) &
                  +rxt(212)*y(73)*y(17)
         loss(38) = (rxt(217)* y(69) +rxt(223)* y(77) + rxt(35))* y(70)
         prod(38) =rxt(196)*y(73)*y(18) +rxt(220)*y(84)*y(71)
         loss(46) = (rxt(192)* y(2) +rxt(221)* y(69) +rxt(220)* y(84) + rxt(34)) &
                 * y(71)
         prod(46) =rxt(191)*y(73)*y(7)
         loss(57) = (rxt(188)* y(1) +rxt(193)* y(12) +rxt(198)* y(15) +rxt(195)* y(18) &
                 )* y(72)
         prod(57) = (rxt(189)*y(2) +rxt(190)*y(6) +rxt(197)*y(17) +rxt(204)*y(80)) &
                 *y(73) + (rxt(194)*y(17) +rxt(218)*y(11))*y(69) +rxt(35)*y(70) &
                  +rxt(34)*y(71) +2.000*rxt(36)*y(74) +2.000*rxt(41)*y(75) +rxt(39) &
                 *y(81)
         loss(66) = (rxt(189)* y(2) +rxt(190)* y(6) +rxt(191)* y(7) + (rxt(197) + &
                 rxt(212))* y(17) +rxt(196)* y(18) + 2.*rxt(200)* y(73) + (rxt(204) + &
                 rxt(211))* y(80))* y(73)
         prod(66) =rxt(188)*y(72)*y(1) +rxt(192)*y(71)*y(2) +2.000*rxt(201)*y(74)
         loss(7) = ( + rxt(36) + rxt(201))* y(74)
         prod(7) =rxt(200)*y(73)*y(73)
         loss(9) = ( + rxt(41))* y(75)
         prod(9) = (rxt(217)*y(70) +rxt(221)*y(71))*y(69)
         loss(49) = (rxt(207)* y(2) +rxt(222)* y(69) +rxt(224)* y(77) + rxt(38)) &
                 * y(76)
         prod(49) =rxt(205)*y(80)*y(18) +rxt(225)*y(84)*y(78)
         loss(53) = (rxt(210)* y(17) +rxt(223)* y(70) +rxt(224)* y(76))* y(77)
         prod(53) = (rxt(208)*y(18) +rxt(209)*y(15))*y(79)
         loss(16) = (rxt(225)* y(84) + rxt(37))* y(78)
         prod(16) =rxt(203)*y(80)*y(7)
         loss(72) = (rxt(202)* y(1) +rxt(209)* y(15) +rxt(208)* y(18))* y(79)
         prod(72) = (rxt(40) +rxt(204)*y(73) +rxt(206)*y(6))*y(80) + (rxt(38) + &
                 2.000*rxt(224)*y(77))*y(76) +rxt(210)*y(77)*y(17) +rxt(37)*y(78) &
                  +rxt(39)*y(81)
         loss(73) = (rxt(206)* y(6) +rxt(203)* y(7) +rxt(205)* y(18) + (rxt(204) + &
                 rxt(211))* y(73) + rxt(40))* y(80)
         prod(73) =rxt(202)*y(79)*y(1) +rxt(207)*y(76)*y(2)
         loss(26) = ( + rxt(39))* y(81)
         prod(26) =rxt(222)*y(76)*y(69) +rxt(223)*y(77)*y(70) +rxt(211)*y(80)*y(73)
         loss(4) = ( + rxt(226))* y(82)
         prod(4) =rxt(63)*y(17)*y(12)
         loss(27) = (rxt(186)* y(1) + rxt(187))* y(83)
         prod(27) = (rxt(73)*y(16) +rxt(75)*y(2))*y(17) +.200*rxt(64)*y(12)*y(3) &
                  +rxt(12)*y(15)
...
!--------------------------------------------------------------------
      if( class == 1 ) then
         ...
         prod(:,3) = (.560*rxt(:,85)*y(:,20) +.300*rxt(:,99)*y(:,21) + &
                 ...
                 .200*rxt(:,121)*y(:,35) +.323*rxt(:,138)*y(:,41))*y(:,1) &
                  + (rxt(:,12) +rxt(:,13) +rxt(:,70)*y(:,8) +rxt(:,71)*y(:,17) + &
                 rxt(:,198)*y(:,72) +rxt(:,209)*y(:,79))*y(:,15) &
                  + (.220*rxt(:,122)*y(:,6) +.220*rxt(:,124)*y(:,8) + &
                 .110*rxt(:,126)*y(:,13) +.220*rxt(:,127)*y(:,25))*y(:,36) &
                  + (rxt(:,166)*y(:,6) +rxt(:,167)*y(:,8) +.400*rxt(:,169)*y(:,13) + &
                 rxt(:,170)*y(:,25))*y(:,58) + (rxt(:,28) +rxt(:,160)*y(:,17) + &
                 rxt(:,161)*y(:,8))*y(:,55) + (rxt(:,33) +.400*rxt(:,179)*y(:,17)) &
                 *y(:,49) +rxt(:,16)*y(:,23) +.700*rxt(:,23)*y(:,34) +1.340*rxt(:,22) &
                 *y(:,35) +rxt(:,30)*y(:,57)
         ...
         prod(:,7) = (rxt(:,58)*y(:,9) +rxt(:,61)*y(:,10) +rxt(:,69)*y(:,14) + &
                 rxt(:,71)*y(:,15) +rxt(:,80)*y(:,19) +rxt(:,81)*y(:,18) + &
                 rxt(:,82)*y(:,17) +rxt(:,89)*y(:,24) +rxt(:,90)*y(:,23) + &
                 rxt(:,96)*y(:,26) +.500*rxt(:,120)*y(:,35) +rxt(:,150)*y(:,44) + &
                 rxt(:,151)*y(:,45) +rxt(:,154)*y(:,46) +rxt(:,160)*y(:,55) + &
                 rxt(:,171)*y(:,59) +rxt(:,172)*y(:,59) +rxt(:,185)*y(:,66) + &
                 rxt(:,194)*y(:,69) +rxt(:,210)*y(:,77))*y(:,17) &
                  + (rxt(:,217)*y(:,70) +rxt(:,222)*y(:,76))*y(:,69) &
                  + (rxt(:,223)*y(:,70) +rxt(:,224)*y(:,76))*y(:,77) +rxt(:,142) &
                 *y(:,18)
...
!----------------------------------------------
      ...
      real, intent(inout) :: mat(imp_nzcnt)
         ...
         mat(639) = -( rxt(5) )
         mat(823) = rxt(6) + .500*rxt(143)
         mat(512) = .110*rxt(9)
         mat(36) = rxt(144)
         mat(42) = 2.000*rxt(47)*y(4)

         mat(829) = -( rxt(6) + rxt(143) )
         mat(113) = rxt(7) + rxt(55)
         mat(172) = rxt(8)
         mat(516) = .890*rxt(9)
         mat(62) = rxt(10) + rxt(62)
         ...
         mat(169) = -( rxt(8) )
         mat(109) = 2.000*rxt(140) + 2.000*rxt(56)*y(84) + 2.000*rxt(219)*y(84)
         mat(488) = rxt(141)
         mat(809) = .500*rxt(143)
         mat(229) = rxt(220)*y(84)
         mat(47) = rxt(225)*y(84)

         mat(59) = -( rxt(10) + rxt(62) )

         mat(108) = -( rxt(7) + rxt(55) + rxt(140) + rxt(56)*y(84) + rxt(219)*y(84) )
         ...
         mat(352) = rxt(193)*y(12)

         mat(163) = -( rxt(35) )
         mat(228) = rxt(220)*y(84)

         mat(230) = -( rxt(34) + rxt(220)*y(84) )

         mat(348) = -( rxt(193)*y(12) )
         mat(232) = rxt(34)
         mat(165) = rxt(35)
         mat(12) = 2.000*rxt(36)
         mat(95) = rxt(39)
         ...
         mat(13) = 2.000*rxt(201)

         mat(11) = -( rxt(36) + rxt(201) )
...
!----------------------------------------------
         ...
         mat(560) = -(rxt(43)*y(2) + rxt(50)*y(6) + rxt(52)*y(7) + rxt(77)*y(17) &
                      + rxt(78)*y(18) + rxt(85)*y(20) + rxt(99)*y(21) + rxt(110)*y(30) &
                      + rxt(119)*y(34) + rxt(121)*y(35) + rxt(138)*y(41) + rxt(163) &
                      *y(57) + rxt(186)*y(83) + rxt(188)*y(72) + rxt(202)*y(79))
         mat(578) = -rxt(43)*y(1)
         mat(636) = -rxt(50)*y(1)
         mat(820) = -rxt(52)*y(1)
         mat(793) = -rxt(77)*y(1)
         ...
         mat(579) = -(rxt(43)*y(1) + rxt(51)*y(7) + rxt(75)*y(17) + rxt(76)*y(18) &
                      + rxt(189)*y(73) + rxt(192)*y(71) + rxt(207)*y(76) + rxt(215) &
                      *y(6))
         mat(561) = -rxt(43)*y(2)
         mat(821) = -rxt(51)*y(2)
         mat(794) = -rxt(75)*y(2)
         ...
         mat(561) = mat(561) + .765*rxt(138)*y(41)
         mat(35) = rxt(145)*y(6) + rxt(216)*y(7)
         mat(637) = mat(637) + rxt(145)*y(5)
         mat(821) = mat(821) + rxt(216)*y(5)
         mat(794) = mat(794) + 2.000*rxt(82)*y(17)
         mat(266) = .765*rxt(138)*y(1)

         mat(34) = -(rxt(145)*y(6) + rxt(216)*y(7))
         mat(611) = -rxt(145)*y(5)
         mat(803) = -rxt(216)*y(5)
         ...
         mat(639) = -(rxt(49)*y(18) + rxt(50)*y(1) + rxt(59)*y(8) + rxt(65)*y(13) &
                      + rxt(87)*y(22) + rxt(92)*y(25) + rxt(101)*y(39) + rxt(107) &
                      *y(51) + rxt(113)*y(33) + (rxt(122) + rxt(123)) * y(36) + rxt(129) &
                      *y(38) + rxt(145)*y(5) + rxt(147)*y(43) + rxt(152)*y(54) + rxt(157) &
                      *y(56) + rxt(166)*y(58) + rxt(190)*y(73) + rxt(206)*y(80) &
                      + rxt(215)*y(2))
         mat(683) = -rxt(49)*y(6)
         mat(563) = -rxt(50)*y(6)
         mat(512) = -rxt(59)*y(6)
         ...
         mat(581) = mat(581) + rxt(51)*y(7)
         mat(823) = rxt(51)*y(2) + rxt(213)*y(8)
         mat(512) = mat(512) + rxt(213)*y(7)

         mat(829) = -(rxt(51)*y(2) + rxt(52)*y(1) + rxt(54)*y(8) + rxt(57)*y(17) &
                      + rxt(60)*y(18) + rxt(93)*y(25) + rxt(135)*y(38) + rxt(191) &
                      *y(73) + rxt(203)*y(80) + rxt(216)*y(5))
         mat(587) = -rxt(51)*y(7)
         mat(569) = -rxt(52)*y(7)
         mat(516) = -rxt(54)*y(7)
         mat(802) = -rxt(57)*y(7)
         ...
         mat(569) = mat(569) + rxt(50)*y(6) + .400*rxt(163)*y(57)
         mat(587) = mat(587) + rxt(215)*y(6)
         mat(645) = rxt(50)*y(1) + rxt(215)*y(2) + 2.000*rxt(59)*y(8) + rxt(65)*y(13) &
                      + rxt(49)*y(18) + rxt(87)*y(22) + rxt(92)*y(25) + .920*rxt(113) &
                      *y(33) + rxt(122)*y(36) + rxt(129)*y(38) + rxt(101)*y(39) &
                      + rxt(147)*y(43) + rxt(107)*y(51) + rxt(152)*y(54) &
                      + 1.206*rxt(157)*y(56) + rxt(166)*y(58) + rxt(190)*y(73) &
                      + rxt(206)*y(80)
         mat(516) = mat(516) + 2.000*rxt(59)*y(6) + 4.000*rxt(214)*y(8) + rxt(53) &
                      *y(18) + rxt(114)*y(33) + rxt(124)*y(36) + rxt(130)*y(38) &
                      + rxt(139)*y(41) + 1.206*rxt(158)*y(56) + rxt(164)*y(57) &
                      + rxt(167)*y(58) + rxt(183)*y(65)
         mat(62) = rxt(61)*y(17)
         mat(113) = rxt(218)*y(69)
         mat(482) = rxt(65)*y(6)
         mat(802) = mat(802) + rxt(61)*y(10) + rxt(155)*y(28) + .400*rxt(162)*y(57)
         mat(689) = mat(689) + rxt(49)*y(6) + rxt(53)*y(8) + .206*rxt(159)*y(56)
         mat(192) = rxt(87)*y(6)
         mat(442) = mat(442) + rxt(92)*y(6)
         mat(54) = rxt(155)*y(17)
         mat(403) = .920*rxt(113)*y(6) + rxt(114)*y(8)
         ...
         mat(107) = rxt(107)*y(6)
         mat(214) = rxt(152)*y(6)
         mat(206) = 1.206*rxt(157)*y(6) + 1.206*rxt(158)*y(8) + .206*rxt(159)*y(18)
         mat(311) = .400*rxt(163)*y(1) + rxt(164)*y(8) + .400*rxt(162)*y(17)
         mat(384) = rxt(166)*y(6) + rxt(167)*y(8)
         mat(33) = rxt(183)*y(8)
         mat(609) = rxt(218)*y(11)
         mat(535) = mat(535) + rxt(190)*y(6)
         mat(723) = mat(723) + rxt(206)*y(6)

         mat(507) = -(rxt(53)*y(18) + (rxt(54) + rxt(213)) * y(7) + rxt(59)*y(6) &
                      + rxt(70)*y(15) + rxt(86)*y(20) + rxt(91)*y(23) + rxt(114)*y(33) &
                      + rxt(124)*y(36) + rxt(130)*y(38) + rxt(139)*y(41) + rxt(156) &
                      *y(21) + rxt(158)*y(56) + rxt(161)*y(55) + rxt(164)*y(57) &
                      + rxt(167)*y(58) + rxt(183)*y(65) + 4.*rxt(214)*y(8))
         mat(678) = -rxt(53)*y(8)
         mat(818) = -(rxt(54) + rxt(213)) * y(8)
         mat(634) = -rxt(59)*y(8)
         mat(729) = -rxt(70)*y(8)
         mat(288) = -rxt(86)*y(8)
         mat(299) = -rxt(91)*y(8)
         ...
         mat(558) = rxt(52)*y(7)
         mat(576) = rxt(192)*y(71)
         mat(818) = mat(818) + rxt(52)*y(1)
         mat(170) = rxt(58)*y(17)
         mat(791) = rxt(58)*y(9) + rxt(177)*y(27) + .500*rxt(176)*y(32)
         mat(132) = rxt(177)*y(17)
         mat(143) = .500*rxt(176)*y(17)
         mat(233) = rxt(192)*y(2)
         ...
         mat(809) = rxt(57)*y(17)
         mat(488) = rxt(70)*y(15) + rxt(91)*y(23) + rxt(161)*y(55)
         mat(109) = rxt(218)*y(69)
         mat(725) = rxt(70)*y(8)
         mat(768) = mat(768) + rxt(57)*y(7)
         mat(295) = rxt(91)*y(8)
         mat(322) = rxt(161)*y(8)
         mat(592) = rxt(218)*y(11) + rxt(221)*y(71)
         mat(229) = rxt(221)*y(69)
         ...
         mat(108) = -(rxt(218)*y(69))
         mat(590) = -rxt(218)*y(11)
         ...
         mat(475) = -(rxt(65)*y(6) + (4.*rxt(66) + 4.*rxt(67)) * y(13) + rxt(68)*y(18) &
                      + rxt(95)*y(25) + rxt(103)*y(39) + rxt(116)*y(33) + rxt(126) &
                      *y(36) + rxt(132)*y(38) + rxt(149)*y(43) + rxt(169)*y(58))
         mat(633) = -rxt(65)*y(13)
         mat(677) = -rxt(68)*y(13)
         mat(435) = -rxt(95)*y(13)
         mat(178) = -rxt(103)*y(13)
         ...
         mat(414) = -rxt(126)*y(13)
         mat(448) = -rxt(132)*y(13)
         mat(221) = -rxt(149)*y(13)
         mat(378) = -rxt(169)*y(13)
         ...
         mat(287) = .310*rxt(85)*y(1)
         mat(435) = mat(435) + rxt(92)*y(6) + .900*rxt(95)*y(13) + 4.000*rxt(98)*y(25) &
                      + rxt(117)*y(33) + rxt(127)*y(36) + rxt(133)*y(38) + rxt(170) &
                      *y(58)
         mat(396) = mat(396) + rxt(117)*y(25)
         mat(414) = mat(414) + rxt(127)*y(25)
         mat(448) = mat(448) + rxt(133)*y(25)
         mat(378) = mat(378) + rxt(170)*y(25)
         ...
         mat(738) = -(rxt(70)*y(8) + rxt(71)*y(17) + rxt(198)*y(72) + rxt(209)*y(79))
         mat(514) = -rxt(70)*y(15)
         mat(800) = -rxt(71)*y(15)
         mat(354) = -rxt(198)*y(15)
         mat(702) = -rxt(209)*y(15)

         mat(567) = .540*rxt(85)*y(20) + .600*rxt(99)*y(21) + rxt(110)*y(30) &
                      + .800*rxt(119)*y(34) + .700*rxt(121)*y(35) + 1.326*rxt(138) &
                      *y(41)
         mat(643) = rxt(65)*y(13) + rxt(87)*y(22) + .550*rxt(113)*y(33) &
                      + .250*rxt(122)*y(36) + rxt(129)*y(38) + rxt(152)*y(54) &
                      + .072*rxt(157)*y(56)
         mat(514) = mat(514) + .600*rxt(114)*y(33) + .250*rxt(124)*y(36) + rxt(130) &
                      *y(38) + .072*rxt(158)*y(56)
         mat(480) = rxt(65)*y(6) + (4.000*rxt(66)+2.000*rxt(67))*y(13) + rxt(95)*y(25) &
                      + 1.200*rxt(116)*y(33) + .880*rxt(126)*y(36) + 2.000*rxt(132) &
                      *y(38) + .700*rxt(103)*y(39) + rxt(149)*y(43) + .700*rxt(169) &
                      *y(58)
         mat(92) = .300*rxt(69)*y(17)
         mat(800) = mat(800) + .300*rxt(69)*y(14) + .500*rxt(96)*y(26) + rxt(177) &
                      *y(27) + .500*rxt(106)*y(30) + .500*rxt(176)*y(32) + rxt(174) &
                      *y(47)
         mat(687) = .008*rxt(159)*y(56)
         mat(292) = .540*rxt(85)*y(1)
         mat(252) = .600*rxt(99)*y(1)
         mat(190) = rxt(87)*y(6)
         mat(440) = rxt(95)*y(13) + .600*rxt(117)*y(33) + .250*rxt(127)*y(36) &
                      + rxt(133)*y(38)
         mat(117) = .500*rxt(96)*y(17)
         mat(133) = rxt(177)*y(17)
         mat(67) = rxt(110)*y(1) + .500*rxt(106)*y(17)
         mat(145) = .500*rxt(176)*y(17)
         mat(401) = .550*rxt(113)*y(6) + .600*rxt(114)*y(8) + 1.200*rxt(116)*y(13) &
                      + .600*rxt(117)*y(25)
         mat(367) = .800*rxt(119)*y(1)
         mat(345) = .700*rxt(121)*y(1)
         ...
         mat(181) = .700*rxt(103)*y(13)
         mat(269) = 1.326*rxt(138)*y(1)
         mat(224) = rxt(149)*y(13)
         mat(138) = rxt(174)*y(17)
         mat(212) = rxt(152)*y(6)
         mat(205) = .072*rxt(157)*y(6) + .072*rxt(158)*y(8) + .008*rxt(159)*y(18)
         mat(382) = .700*rxt(169)*y(13)
...
!----------------------------------------------
         ...
         mat(801) = -(rxt(57)*y(7) + rxt(58)*y(9) + rxt(61)*y(10) + rxt(69)*y(14) &
                      + rxt(71)*y(15) + rxt(75)*y(2) + rxt(77)*y(1) + rxt(80)*y(19) &
                      + rxt(81)*y(18) + (4.*rxt(82) + 4.*rxt(199)) * y(17) + rxt(84) &
                      *y(20) + rxt(89)*y(24) + rxt(90)*y(23) + rxt(96)*y(26) + rxt(105) &
                      *y(40) + rxt(106)*y(30) + rxt(111)*y(21) + rxt(112)*y(31) &
                      + rxt(118)*y(34) + rxt(120)*y(35) + rxt(128)*y(37) + rxt(137) &
                      *y(41) + rxt(150)*y(44) + rxt(151)*y(45) + rxt(154)*y(46) &
                      + rxt(155)*y(28) + rxt(160)*y(55) + rxt(162)*y(57) + rxt(165) &
                      *y(53) + rxt(171)*y(59) + rxt(173)*y(60) + rxt(174)*y(47) &
                      + rxt(175)*y(48) + rxt(176)*y(32) + rxt(177)*y(27) + rxt(178) &
                      *y(50) + rxt(179)*y(49) + rxt(180)*y(63) + (rxt(181) + rxt(182) &
                      ) * y(65) + rxt(185)*y(66) + rxt(194)*y(69) + (rxt(197) + rxt(212) &
                      ) * y(73) + rxt(210)*y(77))
         mat(828) = -rxt(57)*y(17)
         mat(171) = -rxt(58)*y(17)
         mat(61) = -rxt(61)*y(17)
         ...
         mat(270) = -rxt(137)*y(17)
         mat(83) = -rxt(150)*y(17)
         mat(160) = -rxt(151)*y(17)
         mat(88) = -rxt(154)*y(17)
         mat(53) = -rxt(155)*y(17)
         mat(327) = -rxt(160)*y(17)
         mat(310) = -rxt(162)*y(17)
         mat(121) = -rxt(165)*y(17)
         mat(28) = -rxt(171)*y(17)
         mat(155) = -rxt(173)*y(17)
         mat(139) = -rxt(174)*y(17)
         mat(58) = -rxt(175)*y(17)
         mat(146) = -rxt(176)*y(17)
         mat(134) = -rxt(177)*y(17)
         mat(335) = -rxt(178)*y(17)
         mat(197) = -rxt(179)*y(17)
         mat(16) = -rxt(180)*y(17)
         mat(32) = -(rxt(181) + rxt(182)) * y(17)
         mat(7) = -rxt(185)*y(17)
         mat(608) = -rxt(194)*y(17)
         mat(534) = -(rxt(197) + rxt(212)) * y(17)
         mat(321) = -rxt(210)*y(17)

         mat(568) = mat(568) + rxt(78)*y(18) + .330*rxt(85)*y(20) + .270*rxt(99)*y(21) &
                      + .120*rxt(110)*y(30) + .080*rxt(119)*y(34) + .215*rxt(121) &
                      *y(35) + 1.156*rxt(138)*y(41) + rxt(186)*y(83)
         mat(586) = mat(586) + rxt(76)*y(18) + rxt(207)*y(76)
         mat(644) = rxt(49)*y(18)
         mat(515) = rxt(53)*y(18)
         mat(93) = mat(93) + .300*rxt(69)*y(17)
         mat(801) = mat(801) + .300*rxt(69)*y(14) + .500*rxt(89)*y(24) + .100*rxt(128) &
         ...
         mat(684) = -(rxt(49)*y(6) + rxt(53)*y(8) + rxt(60)*y(7) + rxt(68)*y(13) &
                      + rxt(76)*y(2) + rxt(78)*y(1) + 4.*rxt(79)*y(18) + rxt(81)*y(17) &
                      + rxt(88)*y(22) + rxt(94)*y(25) + rxt(102)*y(39) + rxt(115) &
                      *y(33) + rxt(125)*y(36) + rxt(131)*y(38) + rxt(148)*y(43) &
                      + rxt(153)*y(54) + rxt(159)*y(56) + rxt(168)*y(58) + rxt(195) &
                      *y(72) + rxt(196)*y(73) + rxt(205)*y(80) + rxt(208)*y(79))
         mat(640) = -rxt(49)*y(18)
         mat(513) = -rxt(53)*y(18)
         mat(824) = -rxt(60)*y(18)
         mat(479) = -rxt(68)*y(18)
         ...
         mat(418) = -rxt(125)*y(18)
         mat(452) = -rxt(131)*y(18)
         mat(223) = -rxt(148)*y(18)
         mat(211) = -rxt(153)*y(18)
         mat(204) = -rxt(159)*y(18)
         mat(381) = -rxt(168)*y(18)
         mat(353) = -rxt(195)*y(18)
         mat(530) = -rxt(196)*y(18)
         mat(718) = -rxt(205)*y(18)
         mat(699) = -rxt(208)*y(18)

         mat(564) = mat(564) + rxt(77)*y(17) + .190*rxt(85)*y(20) + .060*rxt(99)*y(21) &
                      + .120*rxt(110)*y(30) + .060*rxt(119)*y(34) + .275*rxt(121) &
                      *y(35) + .102*rxt(138)*y(41) + rxt(163)*y(57)
         mat(640) = mat(640) + rxt(65)*y(13) + rxt(87)*y(22) + rxt(113)*y(33) &
                      + .470*rxt(122)*y(36) + rxt(101)*y(39) + rxt(147)*y(43) &
                      + .794*rxt(157)*y(56) + 1.500*rxt(166)*y(58)
         mat(513) = mat(513) + rxt(70)*y(15) + rxt(114)*y(33) + .470*rxt(124)*y(36) &
                      + .794*rxt(158)*y(56) + rxt(164)*y(57) + 1.500*rxt(167)*y(58)
         mat(479) = mat(479) + rxt(65)*y(6) + 4.000*rxt(66)*y(13) + .900*rxt(95)*y(25) &
                      + rxt(116)*y(33) + .730*rxt(126)*y(36) + rxt(132)*y(38) &
                      + rxt(103)*y(39) + rxt(149)*y(43) + rxt(169)*y(58)
         mat(735) = rxt(70)*y(8) + rxt(71)*y(17) + rxt(198)*y(72) + rxt(209)*y(79)
         mat(797) = mat(797) + rxt(77)*y(1) + rxt(71)*y(15) + rxt(80)*y(19) &
                      + .250*rxt(106)*y(30) + .500*rxt(176)*y(32) + .200*rxt(128) &
                      *y(37) + rxt(174)*y(47) + rxt(175)*y(48) + .600*rxt(179)*y(49) &
                      + rxt(178)*y(50) + rxt(162)*y(57) + rxt(197)*y(73)
         mat(684) = mat(684) + .794*rxt(159)*y(56)
         mat(20) = rxt(80)*y(17)
         mat(291) = .190*rxt(85)*y(1)
         mat(251) = .060*rxt(99)*y(1)
         mat(189) = mat(189) + rxt(87)*y(6)
         mat(439) = mat(439) + .900*rxt(95)*y(13) + rxt(117)*y(33) + .470*rxt(127) &
                      *y(36) + 1.500*rxt(170)*y(58)
         mat(66) = .120*rxt(110)*y(1) + .250*rxt(106)*y(17)
         mat(144) = .500*rxt(176)*y(17)
         mat(400) = mat(400) + rxt(113)*y(6) + rxt(114)*y(8) + rxt(116)*y(13) &
                      + rxt(117)*y(25)
         mat(366) = .060*rxt(119)*y(1)
         mat(344) = .275*rxt(121)*y(1)
         ...
         mat(180) = mat(180) + rxt(101)*y(6) + rxt(103)*y(13) + 2.400*rxt(104)*y(39)
         mat(268) = .102*rxt(138)*y(1)
         mat(223) = mat(223) + rxt(147)*y(6) + rxt(149)*y(13)
         mat(137) = rxt(174)*y(17)
         mat(57) = rxt(175)*y(17)
         mat(195) = .600*rxt(179)*y(17)
         mat(333) = rxt(178)*y(17)
         mat(204) = mat(204) + .794*rxt(157)*y(6) + .794*rxt(158)*y(8) + .794*rxt(159) &
                      *y(18)
         mat(308) = rxt(163)*y(1) + rxt(164)*y(8) + rxt(162)*y(17)
         mat(381) = mat(381) + 1.500*rxt(166)*y(6) + 1.500*rxt(167)*y(8) + rxt(169) &
                      *y(13) + 1.500*rxt(170)*y(25)
         mat(353) = mat(353) + rxt(198)*y(15)
         mat(530) = mat(530) + rxt(197)*y(17)
         mat(699) = mat(699) + rxt(209)*y(15)

         mat(19) = -(rxt(80)*y(17))
         mat(746) = -rxt(80)*y(19)

         mat(746) = mat(746) + 2.000*rxt(199)*y(17)
         mat(646) = 2.000*rxt(79)*y(18)
         ...
         mat(241) = -(rxt(99)*y(1) + rxt(111)*y(17) + rxt(156)*y(8))
         mat(542) = -rxt(99)*y(21)
         mat(774) = -rxt(111)*y(21)
         mat(491) = -rxt(156)*y(21)
         ...
         mat(545) = .500*rxt(85)*y(20) + .040*rxt(119)*y(34)
         mat(621) = rxt(87)*y(22) + rxt(101)*y(39) + .270*rxt(147)*y(43)
         mat(465) = .800*rxt(103)*y(39)
         mat(777) = mat(777) + .500*rxt(105)*y(40) + rxt(175)*y(48)
         mat(284) = .500*rxt(85)*y(1)
         mat(186) = rxt(87)*y(6)
         mat(356) = .040*rxt(119)*y(1)
         mat(177) = rxt(101)*y(6) + .800*rxt(103)*y(13) + 3.200*rxt(104)*y(39)
         mat(76) = .500*rxt(105)*y(17)
         mat(219) = .270*rxt(147)*y(6)
         mat(56) = rxt(175)*y(17)
         ...
         mat(433) = -(rxt(92)*y(6) + rxt(93)*y(7) + rxt(94)*y(18) + rxt(95)*y(13) &
                      + 4.*rxt(98)*y(25) + rxt(117)*y(33) + rxt(127)*y(36) + rxt(170) &
                      *y(58))
         mat(631) = -rxt(92)*y(25)
         mat(815) = -rxt(93)*y(25)
         mat(675) = -rxt(94)*y(25)
         ...
         mat(394) = -rxt(117)*y(25)
         mat(412) = -rxt(127)*y(25)
         mat(376) = -rxt(170)*y(25)

         mat(631) = mat(631) + .530*rxt(122)*y(36) + rxt(129)*y(38) + rxt(152)*y(54)
         mat(504) = rxt(91)*y(23) + .530*rxt(124)*y(36) + rxt(130)*y(38) + rxt(161) &
                      *y(55)
         mat(473) = mat(473) + .260*rxt(126)*y(36) + rxt(132)*y(38)
         mat(788) = rxt(90)*y(23) + .500*rxt(96)*y(26) + rxt(160)*y(55)
         mat(297) = rxt(91)*y(8) + rxt(90)*y(17)
         mat(433) = mat(433) + .530*rxt(127)*y(36)
         mat(115) = .500*rxt(96)*y(17)
         mat(412) = mat(412) + .530*rxt(122)*y(6) + .530*rxt(124)*y(8) + .260*rxt(126) &
         ...
         mat(446) = rxt(129)*y(6) + rxt(130)*y(8) + rxt(132)*y(13) + 4.000*rxt(134) &
                      *y(38)
         mat(209) = rxt(152)*y(6)
         mat(324) = rxt(161)*y(8) + rxt(160)*y(17)
...
!----------------------------------------------
         ...
         mat(129) = -(rxt(177)*y(17))
         mat(763) = -rxt(177)*y(27)

         mat(807) = rxt(93)*y(25)
         mat(424) = rxt(93)*y(7)

         mat(51) = -(rxt(155)*y(17))
         mat(749) = -rxt(155)*y(28)
         ...
         mat(140) = -(rxt(176)*y(17))
         mat(765) = -rxt(176)*y(32)
         ...
         mat(502) = mat(502) + 1.700*rxt(139)*y(41)
         mat(786) = rxt(111)*y(21) + 1.640*rxt(137)*y(41) + .500*rxt(173)*y(60)
         mat(246) = rxt(111)*y(17)
         mat(261) = 1.700*rxt(139)*y(8) + 1.640*rxt(137)*y(17)
         mat(152) = .500*rxt(173)*y(17)
         ...
         mat(551) = mat(551) + .200*rxt(99)*y(21) + .442*rxt(138)*y(41)
         mat(627) = .320*rxt(113)*y(33) + .039*rxt(157)*y(56)
         mat(500) = .350*rxt(114)*y(33) + .039*rxt(158)*y(56)
         mat(469) = .260*rxt(116)*y(33)
         mat(671) = .039*rxt(159)*y(56)
         mat(245) = .200*rxt(99)*y(1)
         mat(429) = .350*rxt(117)*y(33)
         mat(390) = .320*rxt(113)*y(6) + .350*rxt(114)*y(8) + .260*rxt(116)*y(13) &
                      + .350*rxt(117)*y(25)
         mat(260) = .442*rxt(138)*y(1)
         mat(201) = .039*rxt(157)*y(6) + .039*rxt(158)*y(8) + .039*rxt(159)*y(18)
         ...
         mat(549) = mat(549) + .400*rxt(99)*y(21) + 1.122*rxt(138)*y(41)
         mat(625) = .230*rxt(113)*y(33) + .167*rxt(157)*y(56)
         mat(498) = .250*rxt(114)*y(33) + .167*rxt(158)*y(56)
         mat(468) = .190*rxt(116)*y(33)
         mat(669) = .167*rxt(159)*y(56)
         mat(244) = .400*rxt(99)*y(1)
         mat(428) = .250*rxt(117)*y(33)
         mat(389) = .230*rxt(113)*y(6) + .250*rxt(114)*y(8) + .190*rxt(116)*y(13) &
                      + .250*rxt(117)*y(25)
         mat(259) = 1.122*rxt(138)*y(1)
         mat(200) = .167*rxt(157)*y(6) + .167*rxt(158)*y(8) + .167*rxt(159)*y(18)
         ...
         mat(556) = .200*rxt(99)*y(21)
         mat(789) = .500*rxt(120)*y(35) + .500*rxt(128)*y(37) + .800*rxt(179)*y(49)
         mat(247) = .200*rxt(99)*y(1)
         mat(341) = .500*rxt(120)*y(17)
         mat(71) = .500*rxt(128)*y(17)
         mat(194) = .800*rxt(179)*y(17)
         ...
         mat(218) = -(rxt(147)*y(6) + rxt(148)*y(18) + rxt(149)*y(13))
         mat(620) = -rxt(147)*y(43)
         mat(663) = -rxt(148)*y(43)
         mat(464) = -rxt(149)*y(43)

         mat(773) = 1.330*rxt(112)*y(31) + rxt(150)*y(44)
         mat(9) = 1.330*rxt(112)*y(17)
         mat(81) = rxt(150)*y(17)

         mat(79) = -(rxt(150)*y(17))
         mat(755) = -rxt(150)*y(44)

         mat(651) = rxt(148)*y(43)
         mat(215) = rxt(148)*y(18)

         mat(156) = -(rxt(151)*y(17))
         mat(767) = -rxt(151)*y(45)

         mat(614) = .820*rxt(147)*y(43)
         mat(460) = .820*rxt(149)*y(43)
         mat(767) = mat(767) + .100*rxt(137)*y(41)
         mat(255) = .100*rxt(137)*y(17)
         mat(216) = .820*rxt(147)*y(6) + .820*rxt(149)*y(13)

         mat(84) = -(rxt(154)*y(17))
         mat(756) = -rxt(154)*y(46)

         mat(652) = rxt(153)*y(54)
         mat(207) = rxt(153)*y(18)

         mat(136) = -(rxt(174)*y(17))
         mat(764) = -rxt(174)*y(47)

         mat(459) = 2.000*rxt(67)*y(13) + .250*rxt(116)*y(33) + .250*rxt(126)*y(36) &
                      + .300*rxt(103)*y(39) + .300*rxt(169)*y(58)
         mat(386) = .250*rxt(116)*y(13)
         mat(405) = .250*rxt(126)*y(13)
         mat(175) = .300*rxt(103)*y(13)
         mat(371) = .300*rxt(169)*y(13)

         mat(55) = -(rxt(175)*y(17))
         mat(750) = -rxt(175)*y(48)

         mat(456) = .200*rxt(103)*y(39)
         mat(173) = .200*rxt(103)*y(13) + .800*rxt(104)*y(39)

         mat(193) = -(rxt(179)*y(17))
         mat(771) = -rxt(179)*y(49)

         mat(617) = .530*rxt(122)*y(36) + .250*rxt(166)*y(58)
         mat(489) = .530*rxt(124)*y(36) + .250*rxt(167)*y(58)
         mat(462) = .260*rxt(126)*y(36) + .100*rxt(169)*y(58)
         mat(425) = .530*rxt(127)*y(36) + .250*rxt(170)*y(58)
         mat(406) = .530*rxt(122)*y(6) + .530*rxt(124)*y(8) + .260*rxt(126)*y(13) &
                      + .530*rxt(127)*y(25)
         mat(372) = .250*rxt(166)*y(6) + .250*rxt(167)*y(8) + .100*rxt(169)*y(13) &
                      + .250*rxt(170)*y(25)

         mat(330) = -(rxt(178)*y(17))
         mat(781) = -rxt(178)*y(50)

         mat(624) = .220*rxt(122)*y(36) + .250*rxt(166)*y(58)
         mat(497) = .220*rxt(124)*y(36) + .250*rxt(167)*y(58)
         mat(467) = .230*rxt(126)*y(36) + .100*rxt(169)*y(58)
         mat(781) = mat(781) + .500*rxt(89)*y(24) + .500*rxt(176)*y(32)
         mat(125) = .500*rxt(89)*y(17)
         mat(427) = .220*rxt(127)*y(36) + .250*rxt(170)*y(58)
         mat(141) = .500*rxt(176)*y(17)
         mat(409) = .220*rxt(122)*y(6) + .220*rxt(124)*y(8) + .230*rxt(126)*y(13) &
                      + .220*rxt(127)*y(25)
         mat(374) = .250*rxt(166)*y(6) + .250*rxt(167)*y(8) + .100*rxt(169)*y(13) &
                      + .250*rxt(170)*y(25)
         ...
         mat(119) = -(rxt(165)*y(17))
         mat(761) = -rxt(165)*y(53)

         mat(540) = .400*rxt(163)*y(57)
         mat(613) = .370*rxt(113)*y(33)
         mat(487) = .400*rxt(114)*y(33)
         mat(458) = .300*rxt(116)*y(33)
         mat(761) = mat(761) + .400*rxt(162)*y(57)
         mat(423) = .400*rxt(117)*y(33)
         mat(385) = .370*rxt(113)*y(6) + .400*rxt(114)*y(8) + .300*rxt(116)*y(13) &
                      + .400*rxt(117)*y(25)
         mat(303) = .400*rxt(163)*y(1) + .400*rxt(162)*y(17)

         mat(208) = -(rxt(152)*y(6) + rxt(153)*y(18))
         mat(619) = -rxt(152)*y(54)
         mat(662) = -rxt(153)*y(54)

         mat(772) = rxt(151)*y(45) + rxt(154)*y(46)
         mat(157) = rxt(151)*y(17)
         mat(85) = rxt(154)*y(17)

         mat(323) = -(rxt(160)*y(17) + rxt(161)*y(8))
         mat(780) = -rxt(160)*y(55)
         mat(496) = -rxt(161)*y(55)

         mat(547) = .950*rxt(119)*y(34) + .800*rxt(121)*y(35)
         mat(623) = .250*rxt(122)*y(36) + .250*rxt(166)*y(58)
         mat(496) = mat(496) + .250*rxt(124)*y(36) + .250*rxt(167)*y(58)
         mat(466) = .240*rxt(126)*y(36) + .100*rxt(169)*y(58)
         mat(780) = mat(780) + rxt(155)*y(28) + rxt(178)*y(50)
         mat(426) = .250*rxt(127)*y(36) + .250*rxt(170)*y(58)
         mat(52) = rxt(155)*y(17)
         mat(357) = .950*rxt(119)*y(1)
         mat(337) = .800*rxt(121)*y(1)
         mat(408) = .250*rxt(122)*y(6) + .250*rxt(124)*y(8) + .240*rxt(126)*y(13) &
                      + .250*rxt(127)*y(25)
         mat(329) = rxt(178)*y(17)
         mat(373) = .250*rxt(166)*y(6) + .250*rxt(167)*y(8) + .100*rxt(169)*y(13) &
                      + .250*rxt(170)*y(25)
...
!----------------------------------------------
         ...
         mat(198) = -(rxt(157)*y(6) + rxt(158)*y(8) + rxt(159)*y(18))
         mat(618) = -rxt(157)*y(56)
         mat(490) = -rxt(158)*y(56)
         mat(661) = -rxt(159)*y(56)

         mat(490) = mat(490) + rxt(156)*y(21)
         mat(240) = rxt(156)*y(8)

         mat(304) = -(rxt(162)*y(17) + rxt(163)*y(1) + rxt(164)*y(8))
         mat(778) = -rxt(162)*y(57)
         mat(546) = -rxt(163)*y(57)
         mat(495) = -rxt(164)*y(57)

         mat(622) = .080*rxt(113)*y(33) + rxt(123)*y(36) + .794*rxt(157)*y(56)
         mat(495) = mat(495) + .794*rxt(158)*y(56)
         mat(666) = .794*rxt(159)*y(56)
         mat(388) = .080*rxt(113)*y(6)
         mat(407) = rxt(123)*y(6)
         mat(199) = .794*rxt(157)*y(6) + .794*rxt(158)*y(8) + .794*rxt(159)*y(18)

         mat(375) = -(rxt(166)*y(6) + rxt(167)*y(8) + rxt(168)*y(18) + rxt(169)*y(13) &
                      + rxt(170)*y(25))
         mat(628) = -rxt(166)*y(58)
         mat(501) = -rxt(167)*y(58)
         mat(672) = -rxt(168)*y(58)
         mat(470) = -rxt(169)*y(58)
         mat(430) = -rxt(170)*y(58)

         mat(785) = rxt(165)*y(53) + rxt(171)*y(59) + .500*rxt(173)*y(60)
         mat(120) = rxt(165)*y(17)
         mat(27) = rxt(171)*y(17)
         mat(151) = .500*rxt(173)*y(17)

         mat(26) = -((rxt(171) + rxt(172)) * y(17))
         mat(747) = -(rxt(171) + rxt(172)) * y(59)

         mat(647) = rxt(168)*y(58)
         mat(370) = rxt(168)*y(18)

         mat(148) = -(rxt(173)*y(17))
         mat(766) = -rxt(173)*y(60)

         mat(656) = rxt(115)*y(33)
         mat(387) = rxt(115)*y(18)

         mat(15) = -(rxt(180)*y(17))
         mat(745) = -rxt(180)*y(63)

         mat(483) = rxt(183)*y(65)
         mat(745) = mat(745) + (rxt(181)+.750*rxt(182))*y(65)
         mat(29) = rxt(183)*y(8) + (rxt(181)+.750*rxt(182))*y(17)


         mat(741) = rxt(180)*y(63)
         mat(14) = rxt(180)*y(17)

         mat(30) = -((rxt(181) + rxt(182)) * y(17) + rxt(183)*y(8))
         mat(748) = -(rxt(181) + rxt(182)) * y(65)
         mat(484) = -rxt(183)*y(65)

         mat(6) = -(rxt(185)*y(17))
         mat(743) = -rxt(185)*y(66)



         mat(602) = -(rxt(194)*y(17) + rxt(217)*y(70) + rxt(218)*y(11) + rxt(221) &
                      *y(71) + rxt(222)*y(76))
         mat(795) = -rxt(194)*y(69)
         mat(166) = -rxt(217)*y(69)
         mat(112) = -rxt(218)*y(69)
         mat(236) = -rxt(221)*y(69)
         mat(277) = -rxt(222)*y(69)

         mat(733) = rxt(198)*y(72)
         mat(795) = mat(795) + rxt(212)*y(73)
         mat(682) = rxt(195)*y(72)
         mat(352) = rxt(198)*y(15) + rxt(195)*y(18)
         mat(528) = rxt(212)*y(17)

         mat(163) = -(rxt(217)*y(69) + rxt(223)*y(77))
         mat(591) = -rxt(217)*y(70)
         mat(313) = -rxt(223)*y(70)

         mat(658) = rxt(196)*y(73)
         mat(519) = rxt(196)*y(18)

         mat(230) = -(rxt(192)*y(2) + rxt(221)*y(69))
         mat(571) = -rxt(192)*y(71)
         mat(593) = -rxt(221)*y(71)

         mat(810) = rxt(191)*y(73)
         mat(520) = rxt(191)*y(7)

         mat(348) = -(rxt(188)*y(1) + rxt(195)*y(18) + rxt(198)*y(15))
         mat(550) = -rxt(188)*y(72)
         mat(670) = -rxt(195)*y(72)
         mat(727) = -rxt(198)*y(72)

         mat(574) = rxt(189)*y(73)
         mat(626) = rxt(190)*y(73)
         mat(110) = rxt(218)*y(69)
         mat(783) = rxt(194)*y(69) + rxt(197)*y(73)
         mat(596) = rxt(218)*y(11) + rxt(194)*y(17)
         mat(522) = rxt(189)*y(2) + rxt(190)*y(6) + rxt(197)*y(17) + rxt(204)*y(80)
         mat(710) = rxt(204)*y(73)

         mat(525) = -(rxt(189)*y(2) + rxt(190)*y(6) + rxt(191)*y(7) + rxt(196)*y(18) &
                      + (rxt(197) + rxt(212)) * y(17) + 4.*rxt(200)*y(73) + (rxt(204) &
                      + rxt(211)) * y(80))
         mat(577) = -rxt(189)*y(73)
         mat(635) = -rxt(190)*y(73)
         mat(819) = -rxt(191)*y(73)
         mat(679) = -rxt(196)*y(73)
         mat(792) = -(rxt(197) + rxt(212)) * y(73)
         mat(713) = -(rxt(204) + rxt(211)) * y(73)

         mat(559) = rxt(188)*y(72)
         mat(577) = mat(577) + rxt(192)*y(71)
         mat(234) = rxt(192)*y(2)
         mat(350) = rxt(188)*y(1)


         mat(517) = 2.000*rxt(200)*y(73)


         mat(588) = rxt(217)*y(70) + rxt(221)*y(71)
         mat(161) = rxt(217)*y(69)
         mat(227) = rxt(221)*y(69)

         mat(273) = -(rxt(207)*y(2) + rxt(222)*y(69) + rxt(224)*y(77))
         mat(572) = -rxt(207)*y(76)
         mat(594) = -rxt(222)*y(76)
         mat(314) = -rxt(224)*y(76)

         mat(664) = rxt(205)*y(80)
         mat(708) = rxt(205)*y(18)

         mat(315) = -(rxt(210)*y(17) + rxt(223)*y(70) + rxt(224)*y(76))
         mat(779) = -rxt(210)*y(77)
         mat(164) = -rxt(223)*y(77)
         mat(274) = -rxt(224)*y(77)

         mat(726) = rxt(209)*y(79)
         mat(667) = rxt(208)*y(79)
         mat(690) = rxt(209)*y(15) + rxt(208)*y(18)


         mat(804) = rxt(203)*y(80)
         mat(705) = rxt(203)*y(7)

         mat(700) = -(rxt(202)*y(1) + rxt(208)*y(18) + rxt(209)*y(15))
         mat(565) = -rxt(202)*y(79)
         mat(685) = -rxt(208)*y(79)
         mat(736) = -rxt(209)*y(79)

         mat(641) = rxt(206)*y(80)
         mat(798) = rxt(210)*y(77)
         mat(531) = rxt(204)*y(80)
         mat(278) = 2.000*rxt(224)*y(77)
         mat(319) = rxt(210)*y(17) + 2.000*rxt(224)*y(76)
         mat(719) = rxt(206)*y(6) + rxt(204)*y(73)

         mat(720) = -(rxt(203)*y(7) + (rxt(204) + rxt(211)) * y(73) + rxt(205)*y(18) &
                      + rxt(206)*y(6))
         mat(826) = -rxt(203)*y(80)
         mat(532) = -(rxt(204) + rxt(211)) * y(80)
         mat(686) = -rxt(205)*y(80)
         mat(642) = -rxt(206)*y(80)

         mat(566) = rxt(202)*y(79)
         mat(584) = rxt(207)*y(76)
         mat(279) = rxt(207)*y(2)
         mat(701) = rxt(202)*y(1)


         mat(589) = rxt(222)*y(76)
         mat(162) = rxt(223)*y(77)
         mat(518) = rxt(211)*y(80)
         mat(272) = rxt(222)*y(69)
         mat(312) = rxt(223)*y(70)
         mat(706) = rxt(211)*y(73)


         mat(97) = -(rxt(186)*y(1))
         mat(538) = -rxt(186)*y(83)
