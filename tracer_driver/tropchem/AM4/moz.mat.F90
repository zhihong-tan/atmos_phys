...
!--------------------------------------------------------------------
         ...
         loss(17) = (rxt(47)* y(6) +rxt(238)* y(7) + rxt(46))* y(5)
         prod(17) =rxt(5)*y(6)
         loss(85) = (rxt(66)* y(1) +rxt(237)* y(2) +rxt(47)* y(5) +rxt(75)* y(8) &
         ...
         prod(85) = (rxt(6) +.500*rxt(200) +rxt(67)*y(2) +rxt(235)*y(8))*y(7) &
         ...
         prod(90) = (rxt(65)*y(18) +rxt(66)*y(1) +2.000*rxt(75)*y(8) +rxt(81)*y(13) + &
                 ...
                 rxt(205)*y(54) +2.000*rxt(236)*y(8))*y(8) + (rxt(10) +rxt(78) + &
                 rxt(77)*y(17))*y(10) + (rxt(7) +rxt(71) +rxt(240)*y(58))*y(11) &
                 ...
                 *y(18) + (rxt(20) +rxt(163) +rxt(174)*y(17))*y(31) + (.600*rxt(19) + &
                 rxt(106))*y(27) +.700*rxt(191)*y(98)*y(1) +rxt(8)*y(9) &
                  ...
                  +rxt(35)*y(80)
         loss(80) = (rxt(75)* y(6) + (rxt(70) +rxt(235))* y(7) + 2.*rxt(236)* y(8) &
         ...
         loss(39) = (rxt(240)* y(58) + (rxt(72) +rxt(241))* y(73) + rxt(7) + rxt(71) &
                  + rxt(197))* y(11)
         ...
         loss(88) = (rxt(86)* y(8) +rxt(87)* y(17) +rxt(220)* y(61) +rxt(231)* y(68) &
                  + rxt(12) + rxt(13))* y(15)
         ...
         prod(21) =.110*rxt(125)*y(21)*y(1) +rxt(221)*y(17)*y(17) +rxt(55)*y(18)*y(18)
         ...
         loss(16) = (rxt(205)* y(8) + (rxt(203) +rxt(204))* y(17))* y(54)
         prod(16) = 0.
         ...
         loss(3) = 0.
         prod(3) =rxt(206)*y(55)
         loss(87) = (rxt(240)* y(11) +rxt(216)* y(17) +rxt(239)* y(59) +rxt(243) &
                 * y(60) +rxt(244)* y(65))* y(58)
         prod(87) = (rxt(215)*y(12) +rxt(217)*y(18) +rxt(220)*y(15))*y(61) &
                  +rxt(234)*y(62)*y(17)
         loss(43) = (rxt(239)* y(58) +rxt(245)* y(66) + rxt(37))* y(59)
         prod(43) =rxt(218)*y(62)*y(18) +rxt(242)*y(73)*y(60)
         loss(50) = (rxt(214)* y(2) +rxt(243)* y(58) +rxt(242)* y(73) + rxt(36)) &
                 * y(60)
         prod(50) =rxt(213)*y(62)*y(7)
         ...
         loss(62) = (rxt(232)* y(17) +rxt(245)* y(59) +rxt(246)* y(65))* y(66)
         prod(62) = (rxt(230)*y(18) +rxt(231)*y(15))*y(68)
         loss(22) = (rxt(247)* y(73) + rxt(39))* y(67)
         prod(22) =rxt(225)*y(69)*y(7)
         ...
         prod(79) = (rxt(42) +rxt(226)*y(62) +rxt(228)*y(6))*y(69) + (rxt(40) + &
                 2.000*rxt(246)*y(66))*y(65) +rxt(232)*y(66)*y(17) +rxt(39)*y(67) &
                  +rxt(41)*y(70)
         loss(81) = (rxt(228)* y(6) +rxt(225)* y(7) +rxt(227)* y(18) + (rxt(226) + &
                 rxt(233))* y(62) + rxt(42))* y(69)
         prod(81) =rxt(224)*y(68)*y(1) +rxt(229)*y(65)*y(2)
         loss(33) = ( + rxt(41))* y(70)
...
!----------------------------------------------
      ...
      real, intent(inout) :: mat(imp_nzcnt)
         ...
         mat(429) = -( rxt(8) )
         mat(144) = 2.000*rxt(197) + 2.000*rxt(72)*y(73) + 2.000*rxt(241)*y(73)
         mat(623) = rxt(198)
         mat(963) = .500*rxt(200)
         mat(236) = rxt(242)*y(73)
         mat(62) = rxt(247)*y(73)

         mat(65) = -( rxt(10) + rxt(78) )

         mat(143) = -( rxt(7) + rxt(71) + rxt(197) + rxt(72)*y(73) + rxt(241)*y(73) )
         ...
         mat(892) = rxt(215)*y(12)

         mat(173) = -( rxt(37) )
         mat(233) = rxt(242)*y(73)

         mat(234) = -( rxt(36) + rxt(242)*y(73) )

         mat(891) = -( rxt(215)*y(12) )
         mat(240) = rxt(36)
         mat(177) = rxt(37)
         mat(17) = 2.000*rxt(38)
         mat(114) = rxt(41)
...
!----------------------------------------------
         ...
         mat(974) = rxt(67)*y(2) + rxt(235)*y(8)
         mat(638) = mat(638) + rxt(235)*y(7)
         ...
         mat(883) = rxt(66)*y(1) + rxt(237)*y(2) + 2.000*rxt(75)*y(8) + rxt(81)*y(13) &
         ...
         mat(642) = mat(642) + 2.000*rxt(75)*y(6) + 4.000*rxt(236)*y(8) + rxt(69) &
                      *y(18) + rxt(196)*y(39) + 1.300*rxt(183)*y(95) + rxt(188)*y(97) &
                      + rxt(205)*y(54)
         mat(68) = rxt(77)*y(17)
         mat(148) = rxt(240)*y(58)
         mat(600) = rxt(81)*y(6)
         ...
         mat(35) = rxt(205)*y(8)
         mat(916) = rxt(240)*y(11)
         mat(951) = mat(951) + rxt(212)*y(6)
         mat(660) = mat(660) + rxt(228)*y(6)
         ...
         mat(634) = -(rxt(69)*y(18) + (rxt(70) + rxt(235)) * y(7) + rxt(75)*y(6) &
         ...
         mat(144) = rxt(240)*y(58)
         mat(920) = rxt(86)*y(8)
         mat(773) = mat(773) + rxt(73)*y(7) + rxt(207)*y(55)
         ...
         mat(329) = rxt(187)*y(8)
         mat(14) = rxt(207)*y(17)
         mat(904) = rxt(240)*y(11) + rxt(243)*y(60)
         mat(236) = rxt(243)*y(58)
         ...
         mat(143) = -(rxt(240)*y(58))
         mat(899) = -rxt(240)*y(11)
...
!----------------------------------------------
         ...
         mat(930) = -(rxt(86)*y(8) + rxt(87)*y(17) + rxt(220)*y(61) + rxt(231)*y(68))
         mat(641) = -rxt(86)*y(15)
         mat(793) = -rxt(87)*y(15)
         mat(893) = -rxt(220)*y(15)
         mat(609) = -rxt(231)*y(15)
         ...
         mat(21) = -rxt(202)*y(17)
         mat(34) = -(rxt(203) + rxt(204)) * y(17)
         mat(15) = -rxt(207)*y(17)
         mat(909) = -rxt(216)*y(17)
         mat(944) = -(rxt(219) + rxt(234)) * y(17)
         mat(360) = -rxt(232)*y(17)
         ...
         mat(990) = mat(990) + rxt(52)*y(18) + rxt(229)*y(65)
         ...
         mat(887) = -rxt(217)*y(18)
         mat(943) = -rxt(218)*y(18)
         mat(652) = -rxt(227)*y(18)
         mat(604) = -rxt(230)*y(18)
         ...
         mat(595) = mat(595) + rxt(81)*y(6) + 4.000*rxt(82)*y(13) + .900*rxt(104) &
                      ...
                      *y(37) + rxt(118)*y(41) + .640*rxt(143)*y(87) + rxt(160)*y(90) &
                      + .700*rxt(167)*y(92)
         mat(924) = rxt(86)*y(8) + rxt(87)*y(17) + rxt(220)*y(61) + rxt(231)*y(68)
         ...
         mat(887) = mat(887) + rxt(220)*y(15)
         mat(943) = mat(943) + rxt(219)*y(17)
         mat(604) = mat(604) + rxt(231)*y(15)
...
!----------------------------------------------
         ...
         mat(732) = mat(732) + 2.000*rxt(221)*y(17)
...
!----------------------------------------------
         ...
         mat(20) = -(rxt(202)*y(17))
         mat(728) = -rxt(202)*y(52)

         mat(612) = rxt(205)*y(54)
         mat(728) = mat(728) + (rxt(203)+.750*rxt(204))*y(54)
         mat(31) = rxt(205)*y(8) + (rxt(203)+.750*rxt(204))*y(17)


         mat(721) = rxt(202)*y(52)
         mat(19) = rxt(202)*y(17)

         mat(32) = -((rxt(203) + rxt(204)) * y(17) + rxt(205)*y(8))
         mat(730) = -(rxt(203) + rxt(204)) * y(54)
         mat(613) = -rxt(205)*y(54)

         mat(13) = -(rxt(207)*y(17))
         mat(727) = -rxt(207)*y(55)



         mat(913) = -(rxt(216)*y(17) + rxt(239)*y(59) + rxt(240)*y(11) + rxt(243) &
                      *y(60) + rxt(244)*y(65))
         mat(792) = -rxt(216)*y(58)
         mat(178) = -rxt(239)*y(58)
         mat(147) = -rxt(240)*y(58)
         mat(241) = -rxt(243)*y(58)
         mat(304) = -rxt(244)*y(58)

         mat(929) = rxt(220)*y(61)
         mat(792) = mat(792) + rxt(234)*y(62)
         mat(716) = rxt(217)*y(61)
         mat(892) = rxt(220)*y(15) + rxt(217)*y(18)
         mat(948) = rxt(234)*y(17)

         mat(173) = -(rxt(239)*y(58) + rxt(245)*y(66))
         mat(900) = -rxt(239)*y(59)
         mat(355) = -rxt(245)*y(59)

         mat(678) = rxt(218)*y(62)
         mat(936) = rxt(218)*y(18)

         mat(234) = -(rxt(214)*y(2) + rxt(243)*y(58))
         mat(982) = -rxt(214)*y(60)
         mat(901) = -rxt(243)*y(60)

         mat(959) = rxt(213)*y(62)
         mat(937) = rxt(213)*y(7)

         mat(891) = -(rxt(210)*y(1) + rxt(217)*y(18) + rxt(220)*y(15))
         mat(832) = -rxt(210)*y(61)
         mat(715) = -rxt(217)*y(61)
         mat(928) = -rxt(220)*y(61)

         mat(993) = rxt(211)*y(62)
         mat(879) = rxt(212)*y(62)
         mat(146) = rxt(240)*y(58)
         mat(791) = rxt(216)*y(58) + rxt(219)*y(62)
         mat(912) = rxt(240)*y(11) + rxt(216)*y(17)
         mat(947) = rxt(211)*y(2) + rxt(212)*y(6) + rxt(219)*y(17) + rxt(226)*y(69)
         mat(656) = rxt(226)*y(62)

         mat(950) = -(rxt(211)*y(2) + rxt(212)*y(6) + rxt(213)*y(7) + rxt(218)*y(18) &
                      + (rxt(219) + rxt(234)) * y(17) + 4.*rxt(222)*y(62) + (rxt(226) &
                      + rxt(233)) * y(69))
         mat(996) = -rxt(211)*y(62)
         mat(882) = -rxt(212)*y(62)
         mat(978) = -rxt(213)*y(62)
         mat(718) = -rxt(218)*y(62)
         mat(794) = -(rxt(219) + rxt(234)) * y(62)
         mat(659) = -(rxt(226) + rxt(233)) * y(62)

         mat(835) = rxt(210)*y(61)
         ...
         mat(897) = rxt(239)*y(59) + rxt(243)*y(60)
         mat(171) = rxt(239)*y(58)
         mat(232) = rxt(243)*y(58)

         mat(298) = -(rxt(229)*y(2) + rxt(244)*y(58) + rxt(246)*y(66))
         mat(983) = -rxt(229)*y(65)
         mat(902) = -rxt(244)*y(65)
         mat(356) = -rxt(246)*y(65)

         mat(686) = rxt(227)*y(69)
         mat(646) = rxt(227)*y(18)

         mat(357) = -(rxt(232)*y(17) + rxt(245)*y(59) + rxt(246)*y(65))
         mat(767) = -rxt(232)*y(66)
         mat(174) = -rxt(245)*y(66)
         mat(299) = -rxt(246)*y(66)

         mat(919) = rxt(231)*y(68)
         mat(691) = rxt(230)*y(68)
         mat(601) = rxt(231)*y(15) + rxt(230)*y(18)


         mat(955) = rxt(225)*y(69)
         mat(644) = rxt(225)*y(7)

         mat(602) = -(rxt(224)*y(1) + rxt(230)*y(18) + rxt(231)*y(15))
         mat(825) = -rxt(224)*y(68)
         mat(708) = -rxt(230)*y(68)
         mat(921) = -rxt(231)*y(68)

         mat(872) = rxt(228)*y(69)
         mat(784) = rxt(232)*y(66)
         mat(940) = rxt(226)*y(69)
         mat(300) = 2.000*rxt(246)*y(66)
         mat(358) = rxt(232)*y(17) + 2.000*rxt(246)*y(65)
         mat(649) = rxt(228)*y(6) + rxt(226)*y(62)

         mat(651) = -(rxt(225)*y(7) + (rxt(226) + rxt(233)) * y(62) + rxt(227)*y(18) &
                      + rxt(228)*y(6))
         mat(970) = -rxt(225)*y(69)
         mat(942) = -(rxt(226) + rxt(233)) * y(69)
         mat(710) = -rxt(227)*y(69)
         mat(874) = -rxt(228)*y(69)

         mat(827) = rxt(224)*y(68)
         mat(988) = rxt(229)*y(65)
         mat(301) = rxt(229)*y(2)
         mat(603) = rxt(224)*y(1)


         mat(898) = rxt(244)*y(65)
         mat(172) = rxt(245)*y(66)
         mat(935) = rxt(233)*y(69)
         mat(297) = rxt(244)*y(58)
         mat(354) = rxt(245)*y(59)
         mat(645) = rxt(233)*y(62)


         mat(115) = -(rxt(208)*y(1))
         mat(800) = -rxt(208)*y(72)
