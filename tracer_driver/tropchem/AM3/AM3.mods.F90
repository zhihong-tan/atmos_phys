...
logical                       :: module_is_initialized = .false.
      ...
      end module AM3_mo_grid_mod

      module AM3_chem_mods_mod
!--------------------------------------------------------------
...
!--------------------------------------------------------------
      ...
      end module AM3_chem_mods_mod
  
      module AM3_M_SPC_ID_MOD
      ...
      end module AM3_M_SPC_ID_MOD
                                                                                
      module AM3_M_RXT_ID_MOD
      ...
      end module AM3_M_RXT_ID_MOD
                                                                                
      module AM3_M_HET_ID_MOD
                                                                                
      implicit none                                                             
                                                                                
                                                                                
      end module AM3_M_HET_ID_MOD
